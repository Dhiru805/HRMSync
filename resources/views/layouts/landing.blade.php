...
<head>
    {{-- <title>{{ __('Hrmsync SaaS') }}</title> --}}
    <title>
        {{ \App\Models\Utility::getValByName('title_text') ? \App\Models\Utility::getValByName('title_text') : config('app.name', 'Hrmsync SaaS') }}
    </title>
    ...
    <meta property="og:image"
        content="{{ isset($meta_logo) && !empty(asset('storage/uploads/meta/hrmgo' . $meta_logo)) ? asset('storage/uploads/meta/' . $meta_logo) : 'hrmgo.png' }}">
    ...
    <meta name="author" content="Bytecraft Studios" />
    ...
    <nav class="navbar navbar-expand-md navbar-dark default top-nav-collapse">
        <div class="container">
            <a class="navbar-brand bg-transparent" href="#">
                ...
                <img src="{{ $logos . '/' . '2_light_logo.png' }}" alt="{{ config('app.name', 'Hrmsync') }}"
                    alt="logo">
            </a>
    ...
    <section id="feature" class="feature">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Features</span> All in one place Hrmsync SaaS
                        system
                    </h2>
                    <p class="m-0">
                        Use these awesome forms to login or create new account in your
    ...
    <section id="price" class="price-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Price</span> All in one place Hrmsync SaaS
                        system
                    </h2>
                    <p class="m-0">
                        Use these awesome forms to login or create new account in your
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    ...
                    {{-- <p class="text-body"> {{ __('Copyright') }} &copy;
                        {{ \App\Models\Utility::getValByName('footer_text') ? \App\Models\Utility::getValByName('footer_text') : config('app.name', 'Hrmsync') }}
                        {{ date('Y') }} </p> --}}
                    <p class="text-body">&copy;{{ __('Copyright') }}
                        {{ \App\Models\Utility::getValByName('footer_text') ? \App\Models\Utility::getValByName('footer_text') : config('app.name', 'Hrmsync SaaS') }}
                        {{ date('Y') }} | Design By Hrmsync </p>
                </div>
            </div>
        </div>
