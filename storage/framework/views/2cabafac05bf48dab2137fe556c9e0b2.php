<?php echo e(Form::model($user, ['route' => ['user.update', $user->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<?php endif; ?>
                <div class="form-icon-user">
                    <?php echo Form::select('role', $roles, $user->roles, ['class' => 'form-control', 'required' => 'required']); ?>
...
<?php /**PATH /home/u661792259/domains/hrmsync.in/public_html/resources/views/user/edit.blade.php ENDPATH**/ ?>