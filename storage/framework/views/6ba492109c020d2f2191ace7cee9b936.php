...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="text-end">
                                        <button class="btn btn-sm btn-primary btn-icon m-1 " data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Create')); ?>" data-repeater-create
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-icon btn-light-secondary delete-button"
                                                                    data-image="<?php echo e($home_logo); ?>" data-bs-toggle="tooltip" data-bs-original-title="<?php echo e(__('Delete')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u661792259/domains/hrmsync.in/public_html/Modules/LandingPage/Resources/views/landingpage/homesection.blade.php ENDPATH**/ ?>