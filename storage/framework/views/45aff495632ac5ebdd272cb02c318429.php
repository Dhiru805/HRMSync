...
<head>
    <title>
        <?php echo e(\App\Models\Utility::getValByName('title_text') ? \App\Models\Utility::getValByName('title_text') : config('app.name', 'Hrmsync SaaS')); ?>
                        ...
                        <div class="navbar-brand">
                            <a href="#">
                                <img src="<?php echo e($logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo . '?' . time() : 'logo_dark.png' . '?' . time())); ?>"
                                    class="logo" alt="<?php echo e(config('app.name', 'Hrmsync SaaS')); ?>" alt="logo"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <span>
                                    ...
                                    <?php endif; ?>
                                    <?php echo e(App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'Hrmsync Saas')); ?>
...
<?php /**PATH /home/u661792259/domains/hrmsync.in/public_html/resources/views/layouts/auth.blade.php ENDPATH**/ ?>