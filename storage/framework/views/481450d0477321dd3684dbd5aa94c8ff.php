...
<head>
    ...
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('assets/landingpage/css/style.css')); ?>" id="main-style-link">
    <?php endif; ?>
...
<div class="popup" id="popup">
    <div class="popup-content">
        ...
        <footer class="site-footer bg-gray-100" style="background: transparent;">
            <div class="container">
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                ...
                <?php if($settings['discover_buy_now_link']): ?>
                    <a href="<?php echo e($settings['discover_buy_now_link']); ?>" class="btn btn-primary"><?php echo e(__('Buy Now')); ?>
...
<script>
    // Function to show popup if not already seen
...
<?php /**PATH /home/u661792259/domains/hrmsync.in/public_html/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>