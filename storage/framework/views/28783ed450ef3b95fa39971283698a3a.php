...
<?php $__env->startPush('script-page'); ?>
    <script src="<?php echo e(asset('assets/landingpage/js/tinymce.min.js')); ?>" referrerpolicy="origin"></script>
        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <?php echo e(Form::open(['route' => 'testimonials.store', 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate'])); ?>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('testimonials_create')); ?>" data-ajax-popup="true"
                                        ...
                                        data-title="<?php echo e(__('Create Testimonials')); ?>" class="btn btn-sm btn-primary">
                                                    ...
                                                    <td>
                                                                <div class="action-btn me-2">
                                                                    <a href="#" class="mx-3 btn btn-sm bg-info align-items-center"
                                                                        ...
                                                                        data-title="<?php echo e(__('Edit Testimonials')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u661792259/domains/hrmsync.in/public_html/Modules/LandingPage/Resources/views/landingpage/testimonials/index.blade.php ENDPATH**/ ?>