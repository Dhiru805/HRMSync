                                        ...
                                        <td>
                                                <div class="action-btn">
                                                    <a href="#" class="mx-3 btn btn-sm bg-warning align-items-center"
                                                        ...
                                                        title="<?php echo e(__('Desciption')); ?>"
                                                        data-title="<?php echo e(__('Desciption')); ?>"><span class="text-white"><i
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Termination')): ?>
                                                            <div class="action-btn me-2">
                                                                <a href="#" class="mx-3 btn btn-sm bg-info align-items-center"
                                                                    ...
                                                                    data-title="<?php echo e(__('Edit Termination')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u661792259/domains/hrmsync.in/public_html/resources/views/termination/index.blade.php ENDPATH**/ ?>