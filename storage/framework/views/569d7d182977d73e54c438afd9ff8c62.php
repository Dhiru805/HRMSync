                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($transaction->status == 0): ?>
                                                            <span
                                                                class="status_badge badge bg-danger p-2 px-3 payout-status"><?php echo e(__(\App\Models\TransactionOrder::$status[$transaction->status])); ?></span>
                                                        <?php elseif($transaction->status == 1): ?>
                                                            <span
                                                                class="status_badge badge bg-warning p-2 px-3 payout-status"><?php echo e(__(\App\Models\TransactionOrder::$status[$transaction->status])); ?></span>
                                                        <?php elseif($transaction->status == 2): ?>
                                                            <span
                                                                class="status_badge badge bg-primary p-2 px-3 payout-status"><?php echo e(__(\App\Models\TransactionOrder::$status[$transaction->status])); ?></span>
                                                        <?php endif; ?>
                                                    </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u661792259/domains/hrmsync.in/public_html/resources/views/referral-program/company.blade.php ENDPATH**/ ?>