    ...
    <div class="m-header main-logo">
        <a href="<?php echo e(route('dashboard')); ?>" class="b-brand">
            ...
            <img src="<?php echo e($logo . (isset($company_logo) && !empty($company_logo) ? $company_logo . '?' . time() : 'logo-dark.png' . '?' . time())); ?>"
                alt="<?php echo e(config('app.name', 'Hrmsync')); ?>" class="logo logo-lg" style="height: 40px;">
        </a>
    </div>
...
<?php /**PATH /home/u661792259/domains/hrmsync.in/public_html/resources/views/partial/Admin/menu.blade.php ENDPATH**/ ?>